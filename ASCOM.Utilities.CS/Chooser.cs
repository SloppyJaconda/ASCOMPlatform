...
public class Chooser : IChooser, IChooserExtra, IDisposable
{
    ...
    public string DeviceType
    {
        ...
        {
            if (Value == "")
                throw new Exceptions.InvalidValueException("Chooser:DeviceType - " + MSG_ILLEGAL_DEVTYPE); // Err.Raise(SCODE_ILLEGAL_DEVTYPE, ERR_SOURCE_PROFILE, MSG_ILLEGAL_DEVTYPE)
