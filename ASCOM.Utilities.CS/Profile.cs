    ...
    public class Profile : IProfile, IProfileExtra, IDisposable
    {
        ...
        public string DeviceType
        {
            ...
            set
            {
                ...
                if (Value == "")
                    throw new Exceptions.InvalidValueException(MSG_ILLEGAL_DEVTYPE);
                m_sDeviceType = Value;
            }
        }
        ...
        {
            return this.IsRegisteredPrv(DriverID, false);
        }
        ...
        public void Register(string DriverID, string DescriptiveName)
        {
            ...
            else
            {
                ...
                if ((CurrentDescription == "") & (DescriptiveName != ""))
                {
        ...
        ///     ''' </remarks>
        public new string GetValue(string DriverID, string Name, string SubKey, string DefaultValue)
        {
            // Get a profile value
            string Rtn;
        ...
        ///     ''' <remarks></remarks>
        public new void WriteValue(string DriverID, string Name, string Value, string SubKey)
        {
        ...
        ///     ''' <para>The KeyValuePair objects are instances of the <see cref="KeyValuePair">KeyValuePair class</see></para>
        ///     ''' </remarks>
        public new ArrayList SubKeys(string DriverID, string SubKey)
        {
            ArrayList RetVal = new ArrayList();
        ...
        public string GetProfileXML(string DriverId)
        {
            ...
            XmlSerializer XMLSer = new XmlSerializer(typeof(ASCOMProfile));
            ...
            using (MemoryStream MemStream = new MemoryStream()) // Create a memory stream to receive the serialised ProfileKey
            {
            ...
            TL.LogMessageCrLf("  GetProfileXML", Constants.vbCrLf + RetVal);
            return RetVal;
        }
        ...
        public void SetProfileXML(string DriverId, string XmlProfile)
        {
            ...
            TL.LogMessageCrLf("SetProfileXML", "Driver: " + DriverId + Constants.vbCrLf + XmlProfile);
            CheckRegistered(DriverId);

            XMLProfileBytes = UTF8.GetBytes(XmlProfile); // Convert the UTF8 XML string into a byte array
            using (MemoryStream MemStream = new MemoryStream(XMLProfileBytes)) // Present the UTF8 string byte array as a memory stream
            {
        ...
        ///     ''' </remarks>
        [ComVisible(false)]
        public new void DeleteValue(string DriverID, string Name)
        {
            this.DeleteValue(DriverID, Name, "");
        }
        ...
        ///     ''' </remarks>
        [ComVisible(false)]
        public new string GetValue(string DriverID, string Name)
        {
            return this.GetValue(DriverID, Name, "", null);
        }
        ...
        ///     ''' </remarks>
        [ComVisible(false)]
        public new string GetValue(string DriverID, string Name, string SubKey)
        {
            return this.GetValue(DriverID, Name, SubKey, null);
        }
        ...
        ///     ''' </remarks>
        [ComVisible(false)]
        public new ArrayList SubKeys(string DriverID)
        {
            return this.SubKeys(DriverID, "");
        }
        ...
        ///     '''  </remarks>
        [ComVisible(false)]
        public new ArrayList Values(string DriverID)
        {
            return this.Values(DriverID, "");
        }
        ...
        ///     ''' </remarks>
        [ComVisible(false)]
        public new void WriteValue(string DriverID, string Name, string Value)
        {
            this.WriteValue(DriverID, Name, Value, "");
        }
        ...
        private string MakeKey(string BaseKey, string SubKey)
        {
            ...
            if (BaseKey != "")
                MakeKey = MakeKey + @"\" + BaseKey; // Allow blank BaseKey (See SubKeys())
            if (SubKey != "")
                MakeKey = MakeKey + @"\" + SubKey;
            return MakeKey;
        }
        ...
        private void CheckRegistered(string DriverID)
        {
            ...
            if (!this.IsRegisteredPrv(DriverID, true))
            {
