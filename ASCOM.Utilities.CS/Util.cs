...
namespace ASCOM.Utilities.CS
{
    ...
    public class Util : IUtil, IUtilExtra, IDisposable
    {
        ...
        public void WaitForMilliseconds(int Milliseconds)
        {
            ...
            if (Milliseconds > 20)
            {
                EndPoint = System.Convert.ToDouble(Milliseconds - 20) * Stopwatch.Frequency / 1000.0;
                do
                {
                    Thread.Sleep(10);
            ...
            EndPoint = System.Convert.ToDouble(Milliseconds) * Stopwatch.Frequency / 1000.0;
            while (m_StopWatch.ElapsedTicks < EndPoint)
                Thread.Sleep(0);
        }
        // 
        ...
        public double DMSToDegrees(string DMS)
        {
            ...
            if (Strings.Left(DMS, 1) == "-")
            {
                ...
                sg = 1;
            if (Strings.InStr(System.Convert.ToString(1.1), ",") > 0)
                Pattern = @"[0-9\,]+";
            else
                Pattern = @"[0-9\.]+";
            ...
            if (ms.Count > 0)
            {
                DMSToDegrees = System.Convert.ToDouble(ms.Item[0].Value); // Degrees
                if (ms.Count > 1)
                {
                    DMSToDegrees = DMSToDegrees + (System.Convert.ToDouble(ms.Item[1].Value) / 60.0); // Minutes
                    if (ms.Count > 2)
                        DMSToDegrees = DMSToDegrees + (System.Convert.ToDouble(ms.Item[2].Value) / 3600.0);// Seconds
                }
            }
        ...
        ///     ''' </remarks>
        [ComVisible(false)]
        public new string DegreesToDMS(double Degrees)
        {
        ...
        ///     ''' </remarks>
        [ComVisible(false)]
        public new string DegreesToDMS(double Degrees, string DegDelim)
        {
        ...
        ///     ''' </remarks>
        [ComVisible(false)]
        public new string DegreesToDMS(double Degrees, string DegDelim, string MinDelim)
        {
        ...
        ///     ''' </remarks>
        [ComVisible(false)]
        public new string DegreesToDMS(double Degrees, string DegDelim, string MinDelim, string SecDelim)
        {
        ...
        ///     ''' characters.</para>
        ///     ''' </remarks>
        public new string DegreesToDMS(double Degrees, string DegDelim, string MinDelim, string SecDelim, int SecDecimalDigits)
        {
            string w, m, s;
            bool n;
            string f;
            ...
            Degrees = (Degrees - System.Convert.ToDouble(w)) * 60.0; // Minutes
            m = Strings.Format(Conversion.Fix(Degrees), "00"); // Integral minutes
            Degrees = (Degrees - System.Convert.ToDouble(m)) * 60.0; // Seconds
            ...
            {
                f = "00."; // Format$ string
                for (i = 1; i <= SecDecimalDigits; i++)
                    f = f + "0";
            }

            s = Strings.Format(Degrees, f); // Format seconds with requested decimal digits
            if (Strings.Left(s, 2) == "60")
            {
                s = Strings.Format(0, f); // Seconds are 0
                m = Strings.Format(System.Convert.ToInt32(m) + 1, "00"); // Carry to minutes
                if (m == "60")
                {
                    m = "00"; // Minutes are 0
                    w = Strings.Format(System.Convert.ToInt32(w) + 1, "00"); // Carry to whole part
                }
            }
        ...
        ///     ''' </remarks>
        [ComVisible(false)]
        public new string HoursToHMS(double Hours)
        {
        ...
        ///     ''' </remarks>
        [ComVisible(false)]
        public new string HoursToHMS(double Hours, string HrsDelim)
        {
        ...
        ///     ''' </remarks>
        [ComVisible(false)]
        public new string HoursToHMS(double Hours, string HrsDelim, string MinDelim)
        {
        ...
        ///     ''' </remarks>
        [ComVisible(false)]
        public new string HoursToHMS(double Hours, string HrsDelim, string MinDelim, string SecDelim)
        {
        ...
        ///     ''' <para>If you need a leading plus sign, you must prepend it yourself. The delimiters are not restricted to single characters.</para>
        ///     ''' </remarks>
        public new string HoursToHMS(double Hours, string HrsDelim, string MinDelim, string SecDelim, int SecDecimalDigits)
        {
        ...
        ///     ''' </remarks>
        [ComVisible(false)]
        public new string DegreesToHMS(double Degrees)
        {
        ...
        ///     ''' </remarks>
        [ComVisible(false)]
        public new string DegreesToHMS(double Degrees, string HrsDelim)
        {
        ...
        ///     ''' </remarks>
        [ComVisible(false)]
        public new string DegreesToHMS(double Degrees, string HrsDelim, string MinDelim)
        {
        ...
        ///     ''' </remarks>
        [ComVisible(false)]
        public new string DegreesToHMS(double Degrees, string HrsDelim, string MinDelim, string SecDelim)
        {
        ...
        ///     ''' <para>If you need a leading plus sign, you must prepend it yourself. The delimiters are not restricted to single characters. </para>
        ///     ''' </remarks>
        public new string DegreesToHMS(double Degrees, string HrsDelim, string MinDelim, string SecDelim, int SecDecimalDigits)
        {
        ...
        ///     ''' </remarks>
        [ComVisible(false)]
        public new string DegreesToDM(double Degrees)
        {
        ...
        ///     ''' </remarks>
        [ComVisible(false)]
        public new string DegreesToDM(double Degrees, string DegDelim)
        {
        ...
        ///     ''' </remarks>
        [ComVisible(false)]
        public new string DegreesToDM(double Degrees, string DegDelim, string MinDelim)
        {
        ...
        ///     ''' <para>If you need a leading plus sign, you must prepend it yourself. The delimiters are not restricted to single characters.</para>
        ///     ''' </remarks>
        public new string DegreesToDM(double Degrees, string DegDelim, string MinDelim, int MinDecimalDigits)
        {
            string w, m, f;
            bool n;
            int i;
        ...
        public bool SerialTrace
        {
            get
            {
                if (myProfile.GetProfile("", SERIAL_FILE_NAME_VARNAME) != "")
                    return true;
                else
                    return false;
            }
        ...
        public double JulianDate
        {
            get
            {
                return this.DateUTCToJulian(DateTime.UtcNow);
            }
        }
        ...
        {
            return this.DateUTCToJulian(CvtUTC(ref LocalDate));
        }
        ...
        {
            return CvtLocal(ref this.DateJulianToUTC(JD));
        }
        ...
        {
            var ToStringCollection = new ArrayList();
        ...
        {
            var ToIntegerCollection = new ArrayList();
        ...
        public double ConvertUnits(double InputValue, Units FromUnits, Units ToUnits)
        {
            ...
            if ((FromUnits >= Units.metresPerSecond) & (FromUnits <= Units.knots) & (ToUnits >= Units.metresPerSecond) & (ToUnits <= Units.knots))
            {
                ...
                switch (FromUnits)
                {
                    case object _ when Units.metresPerSecond:
                        {
                            intermediateValue = InputValue;
                            break;
                        }

                    case object _ when Units.milesPerHour:
                        {
                            intermediateValue = InputValue * 0.44704;
                            break;
                        }

                    case object _ when Units.knots:
                        {
            ...
            else if ((FromUnits >= Units.degreesCelsius) & (FromUnits <= Units.degreesKelvin) & (ToUnits >= Units.degreesCelsius) & (ToUnits <= Units.degreesKelvin))
            {
                ...
                switch (FromUnits)
                {
                    case object _ when Units.degreesCelsius:
                        {
                            intermediateValue = InputValue - ABSOLUTE_ZERO_CELSIUS;
                            break;
                        }

                    case object _ when Units.degreesFahrenheit:
                        {
                            intermediateValue = (InputValue + 459.67) * 5.0 / 9.0;
                            break;
                        }

                    case object _ when Units.degreesKelvin:
                        {
                            intermediateValue = InputValue;
                            break;
                        }
            ...
            else if ((FromUnits >= Units.hPa) & (FromUnits <= Units.inHg) & (ToUnits >= Units.hPa) & (ToUnits <= Units.inHg))
            {
                ...
                switch (FromUnits)
                {
                    case object _ when Units.hPa:
                        {
                            intermediateValue = InputValue;
                            break;
                        }

                    case object _ when Units.mBar:
                        {
                            intermediateValue = InputValue;
                            break;
                        }

                    case object _ when Units.mmHg:
                        {
                            intermediateValue = InputValue * 1.33322368;
                            break;
                        }

                    case object _ when Units.inHg:
                        {
            ...
            else if ((FromUnits >= Units.mmPerHour) & (FromUnits <= Units.inPerHour) & (ToUnits >= Units.mmPerHour) & (ToUnits <= Units.inPerHour))
            {
                ...
                switch (FromUnits)
                {
                    case object _ when Units.mmPerHour:
                        {
                            intermediateValue = InputValue;
                            break;
                        }

                    case object _ when Units.inPerHour:
                        {
        ...
        public object ArrayToVariantArray(object SuppliedObject)
        {
            ...
            try
            {
                ...
                if (TypeOfSuppliedObject.IsArray)
                {
                    ...
                    {
                        case object _ when typeof(object).Name:
                            {
                                ReturnObject = SuppliedObject; // Already a variant array so just return the original array
                                break;
                            }

                        case object _ when typeof(Int16).Name:
                            {
                                ReturnObject = ProcessArray<Int16>(SuppliedObject, SuppliedArray);
                                break;
                            }

                        case object _ when typeof(Int32).Name:
                            {
                                ReturnObject = ProcessArray<Int32>(SuppliedObject, SuppliedArray);
                                break;
                            }

                        case object _ when typeof(Int64).Name:
                            {
                                ReturnObject = ProcessArray<Int64>(SuppliedObject, SuppliedArray);
                                break;
                            }

                        case object _ when typeof(UInt16).Name:
                            {
                                ReturnObject = ProcessArray<UInt16>(SuppliedObject, SuppliedArray);
                                break;
                            }

                        case object _ when typeof(UInt32).Name:
                            {
                                ReturnObject = ProcessArray<UInt32>(SuppliedObject, SuppliedArray);
                                break;
                            }

                        case object _ when typeof(UInt64).Name:
                            {
                                ReturnObject = ProcessArray<UInt64>(SuppliedObject, SuppliedArray);
                                break;
                            }

                        case object _ when typeof(byte).Name:
                            {
                                ReturnObject = ProcessArray<byte>(SuppliedObject, SuppliedArray);
                                break;
                            }

                        case object _ when typeof(sbyte).Name:
                            {
                                ReturnObject = ProcessArray<sbyte>(SuppliedObject, SuppliedArray);
                                break;
                            }

                        case object _ when typeof(float).Name:
                            {
                                ReturnObject = ProcessArray<float>(SuppliedObject, SuppliedArray);
                                break;
                            }

                        case object _ when typeof(double).Name:
                            {
                                ReturnObject = ProcessArray<double>(SuppliedObject, SuppliedArray);
                                break;
                            }

                        case object _ when typeof(bool).Name:
                            {
                                ReturnObject = ProcessArray<bool>(SuppliedObject, SuppliedArray);
                                break;
                            }

                        case object _ when typeof(DateTime).Name:
                            {
                                ReturnObject = ProcessArray<DateTime>(SuppliedObject, SuppliedArray);
                                break;
                            }

                        case object _ when typeof(string).Name:
                            {
                                ReturnObject = ProcessArray<string>(SuppliedObject, SuppliedArray);
                                break;
                            }
                ...
                case 1:
                    {
                        ...
                        ObjectArray1 = new object[SuppliedArray.GetLength(0) - 1 + 1];
                ...
                case 2:
                    {
                        ...
                        ObjectArray2 = new object[TwoDimArray.GetLength(0) - 1 + 1, TwoDimArray.GetLength(1) - 1 + 1];
                ...
                case 3:
                    {
                        ...
                        ObjectArray3 = new object[ThreeDimArray.GetLength(0) - 1 + 1, ThreeDimArray.GetLength(1) - 1 + 1, ThreeDimArray.GetLength(2) - 1 + 1];
                ...
                case 4:
                    {
                        ...
                        ObjectArray4 = new object[FourDimArray.GetLength(0) - 1 + 1, FourDimArray.GetLength(1) - 1 + 1, FourDimArray.GetLength(2) - 1 + 1, FourDimArray.GetLength(3) - 1 + 1];
                ...
                case 5:
                    {
                        ...
                        ObjectArray5 = new object[FiveDimArray.GetLength(0) - 1 + 1, FiveDimArray.GetLength(1) - 1 + 1, FiveDimArray.GetLength(2) - 1 + 1, FiveDimArray.GetLength(3) - 1 + 1, FiveDimArray.GetLength(4) - 1 + 1];
        ...
        {
            return (DateTime)System.DateTime.FromOADate(d.ToOADate() + (GetTimeZoneOffset() / 24.0));
        }
